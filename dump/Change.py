...
# # class RelayKeys:
#     # RelayKeys class implementation...

# # Instantiate RelayKeys
# # rc = RelayKeys()
...
# # Function to perform relay operation
# # def relay_opr(param):
#     # relay_opr implementation...
...
#     # Example: Perform a relay operation
#     param = {
#         "device_id": 1,
#         "channel_id": 2,
#         "device_status": "true"
...
#     # Example: Send data to the UDP listener for processing
#     data_to_send = "Hello, UDP listener!"
#     s = socket(AF_INET, SOCK_DGRAM)
#     s.sendto(data_to_send.encode(), ('0.0.0.0', 6000))
...
def get_device_status(device_id, channel_id):
    ...
    # Send the operation to retrieve status
    relay_opr(param)
...
if __name__ == "__main__":
    ...
    data_to_send = "Hello, UDP listener!"
    s = socket(AF_INET, SOCK_DGRAM)
    s.sendto(data_to_send.encode(), ('localhost', 6000))

    # Example: Retrieve device status
    device_id = 1
    channel_id = 2
    get_device_status(device_id, channel_id)

...
# {'id': 13, 'device_name': 'Rope', 'device_type': 'LED', 'hardware_details_id_id': 2, 'is_used': 'No', 'device_informations': {'is_dimmable': 'false', 'isFan': 'false', 'device_id': '61', 'channel_id': '10', 'device_status': 'true', 'image_id': '0', 'delay_second': '0'}, 'status': 'Active', 'is_deleted': 'No'}
    ...
    var app = (function() {
        ...
        var localStorageWrapper = (function() {
            ...
            return {
                save : function() {
                    ...
                    var url = 'http://'+window.location.hostname+':'+ window.location.port+'/'+'CropAreasList'
                    console.log(result)
                    ...
                    fetch(url                       
                        ...
                        .then(response => {
                          ...
                          if (response.ok) {
                            ...
                            console.log("Failed to post object.");
                          }
                        })
                        .catch(error => {
        ...
        return {
            ...
            addObject : function(object) {
                console.log(object,"my obj values")
